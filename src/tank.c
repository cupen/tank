...
//char index = 0;
//void tank_info(int x, int y,const Tank *tank, PCCOLOR color)
//{
//	// system("cls");
//	char temp[32] = {};
...
//	if(0 >= tank->live)
//	{
//	    draw_string(x,y+3,LIGHT_GRAY,"You are dead!!!!!!");
//	}
//}
//
//
...
//}
//
//void operate_tank_with_input(Tank *tank, BulletManager *bullet_manager)
//{
//    int i=0;
...
//        if( index & (0x80>>i) )
//        {
//            draw_block( tank->x + tankView_x[i],
//                       tank->y + tankView_y[i],
//                       tank->color,
//                       1);
//        }
//    }
//    draw_block(tank->x, tank->y, tank->color, 1);
//}
//
...
//	{
//		case UP:
//            draw_block(tank->x,tank->y+1,BLACK,0);
//			draw_block(tank->x,tank->y+2,BLACK,0);
//			draw_block(tank->x-1,tank->y+2,BLACK,0);
//			draw_block(tank->x+1,tank->y+2,BLACK,0);
//			break;
//
//		case DOWN:
...
//
//		case LEFT:
//            draw_block(tank->x+1,tank->y,BLACK,0);
//			draw_block(tank->x+2,tank->y,BLACK,0);
//            draw_block(tank->x+2,tank->y-1,BLACK,0);
//            draw_block(tank->x+2,tank->y+1,BLACK,0);
//			break;
//
//		case RIGHT:
...
//}
//
//void move_tanks(TankManager* t_m, BulletManager* b_m)
//{
...
//	{
//		if( 1 == tank->id ){
//            operate_tank_with_input( tank, b_m );
//		} else {
//            operate_tank_with_AI(tank, b_m);
//            if( 0 >= tank->live){
//                Tank* temp = tank->nextTank;
//
//                add_boom(tank->x, tank->y, tank->color, t_m);    // tank boom^
//                del_tank(t_m, tank);
//                tank = temp;
//                //continue;
//                return;
...
//
//		move_tank(tank);
//		operate_tank_hit_tank(tank, t_m);
...
//}
//
//void draw_tanks(const TankManager *tank_manager)
//{
...
//}
//
//void clean_tanks(const TankManager *tank_manager)
//{
//    Tank *tank = tank_manager->nextTank;
//
//	while(NULL != tank)
...
//}
//
//void tank_fire(Tank *tank, const BulletManager *bullet_manager)
//{
...
//{
//    TankManager *tempT_B = (TankManager*)malloc(sizeof(TankManager));
...
//}
//
//void destroy_tank_manager(TankManager *t_m)
//{
//    Tank *tank = t_m->nextTank;
...
//
//
//int addTankWithRandom(TankManager *t_m)
//{
...
//        if(NULL != others)
//        {
//            while(check_tank_hit_tank(temp, others)) // fang zhi peng zhuang
//            {
//                srand(rand());
//                temp->x = rand();
//                temp->y = rand();
...
//
//
//void operate_tank_with_AI(Tank *tank, BulletManager *b_m)
//{
//	switch(rand() % 13)
//	{
//		case 0:
...
//}
//
//void Tank_Manager_Info(int x, int y, TankManager* t_m, PCCOLOR color)
//{
//    Tank* tank = t_m->nextTank;
//    char temp[32] = {};
